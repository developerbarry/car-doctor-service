            ...
            <div className="font-inter">
                <div className="lg:max-w-5xl max-w-3xl mx-auto">
                    <div className="text-center lg:px-48 mb-14">
                        <span className="font-bold text-base text-[#FF3811] inline-block mb-4">Team</span>
                        <h3 className="text-3xl md:text-[40px] font-bold mb-5">Meet Our Team</h3>
                    ...
                    <div className="grid lg:grid-cols-3 md:grid-cols-2 gap-6 max-md:justify-center mt-12">
                        <div className="border w-full px-4 py-4 rounded-lg overflow-hidden">
                            <img src="https://i.ibb.co.com/BcGDKGT/1.jpg" className="w-full rounded-md h-56 object-cover" />

                            <div className="text-center mt-5">
                                <h4 className="text-gray-800 text-[22px] font-bold">Car Engine Plug</h4>
                                <p className="text-gray-800 text-[17px]">Engine Expert</p>
                        ...
                        <div className="border w-full px-4 py-4 rounded-lg overflow-hidden">
                            <img src="https://i.ibb.co.com/pJw8bFG/2.jpg" className="w-full rounded-md h-56 object-cover" />
                        ...
                        <div className="border w-full px-4 py-4 rounded-lg overflow-hidden">
                            <img src="https://i.ibb.co.com/xs5YcNy/3.jpg" className="w-full rounded-md h-56 object-cover" />
